...
<iframe src="https://editor.raspberrypi.org/nl-NL/embed/viewer/flip-treat-webcards-step-7" width="550" height="710" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen> </iframe>
        ...
        <div class="card">
          <div class="card-content">
            <div class="card-face gradient1 rounded">
              <img src="AfbeeldingNaam.png" alt="Lapis Sarawak." />
            </div>
            <div class="card-face flipme gradient2 rounded ycenter">
              <h2>LekkernijNaam</h2>
              <p>LekkernijBeschrijving</p>
            </div>
          </div>
        </div>
    </section>
...
Je kunt het [geüpgradede project hier](https://editor.raspberrypi.org/nl-NL/projects/flip-treat-webcards-step-7){:target="_blank"} bekijken.
