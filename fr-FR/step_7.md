...
<iframe src="https://editor.raspberrypi.org/fr-FR/embed/viewer/flip-treat-webcards-step-7" width="550" height="710" frameborder="0" marginwidth="0" marginheight="0" allowfullscreen> </iframe>
        ...
        <div class="card">
          <div class="card-content">
            <div class="card-face gradient1 rounded">
              <img src="NomImage.png" alt="Lapis Sarawak." />
            </div>
            <div class="card-face flipme gradient2 rounded ycenter">
              <h2>NomFriandise</h2>
              <p>DescriptionFriandise</p>
            </div>
          </div>
        </div>
    </section>
